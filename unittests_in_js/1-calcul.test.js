/**
 * Tests calculateNumber() function by passing different operations
 * and input values and asserting the expected output.
 * Covers cases with decimal input values to test rounding behavior.
 * Also tests edge cases like divide by zero errors.
 */
