/**
 * Test suites for the calculateNumber module.
 *
 * Includes tests for the SUM, SUBTRACT, and DIVIDE operations.
 * Tests that inputs are rounded properly and correct results are returned.
 */
