#!/usr/bin/env python3
"""
counts cache methods, retreives data,stores data. 
"""
import redis
import uuid
...
def call_history(method: Callable) -> Callable:
    ...
    def wrapper(self, *args, **kwargs):
        """
       Uses rpush to append input to list of inputs.
        """
...
def count_calls(method: Callable) -> Callable:
    """
    Counts the Cache() method is called.
    ...
    def wrapper(self, *args, **kwargs):
        """
    increment the number of times the method has been called.
        """
        key = method.__qualname__
